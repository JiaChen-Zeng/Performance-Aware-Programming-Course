...
decode-exe: does [
    output: "bits 16^/" ; basic buffering
    ...
    while [not tail? cur] [
        ...
        case [
            complement (byte1 >> 2 xor b00'100010) = b00'111111 [
                ...
                append output rejoin ["mov " inst-reg/(inst-reg-start + r_m + 1) ", " inst-reg/(inst-reg-start + reg + 1) newline]
            ]
            true [dprint ["Unrecognized: " enbase/base to-binary byte1 2] exit]
        ]
        cur: skip cur 2
    ]
